...
<title>Mohammad Othman Al-Moallim  VAT Invoice Price (<?=$headerDet->SH_INV_PREFIX?"Invoice":"Order"?> #<?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_PREFIX:$headerDet->SH_ORDER_PREFIX?>-<?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_NO:$headerDet->SH_ORDER_NO?>)</title>
</head>
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0" class="inv">
                                                              ...
                                                              <tr height="20">
                                                                ...
                                                                <td align="left" width="150"><?=$headerDet->CUST_TAX_EXEMPT_ID?></td>
                                                              </tr>
...
"><?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_PREFIX:$headerDet->SH_ORDER_PREFIX?>-<?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_NO:$headerDet->SH_ORDER_NO?></td>
                                            ...
                                            <thead>
                                                <tr>
                                                  <th width="8%">رقم القطعه</th>
                                                    <th width="45%">وصف القطعة</th>
                                                    <th width="2%">الوحدة</th>
                                                    <th width="2%">الكمية</th>
                                                    <th width="10%">السعر القطعة</th>
                                                    <!--<th width="15%">Total Discount</th>-->
                                                    <th width="10%">السعر بعد الخصم</th>
                                                    <th width="2%">الضريبه نسبة</td>
                                                    <th width="10%">ضريبة القيمة المضافة بالريال </th>
                                                    <th width="20%">المبلغ شامل الضريبة بالريال</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                  <td width="8%"><?php if($poItemDet->I_PRINTABLE == 'Y'){ ?><img src="<?=base_url('uploads/images/item/').$poItemDet->I_IMAGE_FILENAME?>" alt="<?=$poItemDet->I_IMAGE_FILENAME?>" title="<?=$poItemDet->I_IMAGE_FILENAME?>" class="avatar-md"><?php }else{ ?><img src="<?=base_url('uploads/images/item/no_image.png')?>" alt="no_image" title="no_image" class="avatar-md"><?php } ?> <?=$poItemDet->SD_ITEM_CODE?></td>
                                                    ...
                                                    <td width="10%"><?=number_format($poItemDet->SD_SALE_PRICE,2)?></td>
                                                    <!--<td width="15%"><?=$poItemDet->SD_DIST_AMT?></td>-->
                                                    <td width="15%"><?=number_format($poItemDet->SO_SUB_TOT,2)?></td>
                                                    <td width="2%">15%</td>
                                                    
                                                    <td width="10%"><?=number_format($poItemDet->SO_VAT_AMT,2)?></td>
  ...
  <tr>
    <td class="sdbod-b"><b>الاجمالى بدون بدون الضريبه</b></td>
