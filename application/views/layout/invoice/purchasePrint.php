...
<title>Mohammad Othman Al-Moallim  VAT Invoice (Invoice #I07-000035)</title>
</head>
...
<!-- ============================================================== -->
  ...
  <tr>
   ...
   <br>920016990 </h2>
Al-Manar Jewellery -2  جدة -شارع التحلية مرآز المنار محل رقم
<br />

 <strong>PHONE</strong> :  966 12 6655306. || <strong>FAX</strong>: 966 12 6644123</td>
...
">فاتورة ضريبية مبسطة</strong>
    <br><strong>الرقم الضريبى:</strong> 300232189200003<br />
     <h4 class="float-end font-size-16"><?=$invoiceData->invoiceType?> #<?=$invoiceData->invoicePrefix?>-<?=$invoiceData->invoiceNo?></h4>
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0" class="inv">
                                                              ...
                                                              <tr height="20">
                                                                ...
                                                                <td align="left" width="227"><?=$headerDet->V_NAME_AR.'-'.$headerDet->V_NAME?></td>
                                                              ...
                                                              <tr height="20">
                                                                ...
                                                                <td align="left"><?=$headerDet->FULL_ADDRESS?></td>
                                                                <td dir="RTL" align="right">&#1578;&#1610;&#1604;&#1610;&#1601;&#1608;&#1606;</td>
                                                                <td align="left"><?=$headerDet->V_CONTACT?></td>
                                                              </tr>
                                                              
                                                              <tr height="20">
                                                                <td height="20" dir="RTL" align="right">&#1589;-&#1575;&#1604;&#1576;&#1585;&#1610;&#1583;</td>
                                                                <td align="left"><?=$headerDet->V_POSTAL_CODE?></td>
                                                              ...
                                                              <tr height="20">
                                                                ...
                                                                <td align="left"><?=$headerDet->V_EMAIL?></td>
                                                              </tr>
                                                            </table>
                                                           </div>
                                                        ...
                                                        <div class="col-sm-12 text-sm-end">
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0" class="inv">
                                                              ...
                                                              <tr height="30">
                                                                ...
                                                                <td align="left" width="295">4030167112**11/40301891 &#1585;&#1602;&#1605; &#1575;&#1604;&#1585;&#1582;&#1589;</td>
                                                              </tr>
    ...
    font-size: 15px;
    font-weight: 700;
"><?=$invoiceData->invoicePrefix?>-<?=$invoiceData->invoiceNo?></td>
                                                              </tr>
                                                              ...
                                                              <tr height="20">
                                                                ...
                                                                <td align="left"><?=$invoiceData->invoiceDate?></td>
                                                              </tr>
                                                            </table>
                                                            </div>
                                        ...
                                        <table class="table table-hover table-striped table-bordered " style="margin-bottom: 0.3rem;">
                                            <thead>
                                                <tr>
                                                  <th width="8%">رقم القطعه</th>
                                                    ...
                                                    <th width="15%">ضريبة القيمة المضافة بالريال </th>
                                            ...
                                            <tbody>
                                                <?php
                                                $sn = 1; foreach ($poItemDets as $poItemDet): $weight = itemGoldDia($poItemDet->POD_ITEM_CODE);?>
                                                <tr>
                                                  <td width="8%"><?php if($poItemDet->I_PRINTABLE == 'Y'){ ?><img src="<?=base_url('uploads/images/item/').$poItemDet->I_IMAGE_FILENAME?>" alt="<?=$poItemDet->I_IMAGE_FILENAME?>" title="<?=$poItemDet->I_IMAGE_FILENAME?>" class="avatar-md"><?php }else{ ?><img src="<?=base_url('uploads/images/item/no_image.png')?>" alt="no_image" title="no_image" class="avatar-md"><?php } ?> <?=$poItemDet->I_CODE?></td>
                                                    ...
                                                    <td width="2%">&nbsp;</td>
                                                    <td width="2%"><?=$poItemDet->POD_ITEM_QTY?></td>
                                                    <!--<td width="15%"><?=$poItemDet->POD_ITEM_PRICE?></td>-->
                                                    <!--<td width="15%"><?=$poItemDet->RD_DIST_AMT?></td>-->
                                                    <td width="15%"><?=$poItemDet->POD_UNIT_COST*$poItemDet->POD_UNIT_COST?></td>
                                                    <td width="2%"><?=$poItemDet->I_FLAMMABLE == 'Y'?'15%':'Tax Free'?></td>
  ...
  <tr>
    <td width="35%" rowspan="5"  align="center" valign="top"  class="sdbod-r sdbod-t sdbod-b sdbod-l">
  ...
  <tr>
    <td class="sdbod-b"><b>لاجمالى بدون بدون الضريبه</b></td>
  ...
  <tr>
    ...
    <td align="right" bgcolor="#E4E4E4" class="sdbod-b sdbod-l sdbod-r" ><strong><span id="curt-cur-abbre-grnd-tot"><?=sysCur()?></span> <span id="grand-tot"><?=number_format($invoiceData->grandTot,2)?></span> </strong></td>
    </tr>
  </table>
