...
<title>Mohammad Othman Al-Moallim  VAT Invoice Gift (<?=$headerDet->SH_INV_PREFIX?"Invoice":"Order"?> #<?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_PREFIX:$headerDet->SH_ORDER_PREFIX?>-<?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_NO:$headerDet->SH_ORDER_NO?>)</title>
</head>
...
"><?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_PREFIX:$headerDet->SH_ORDER_PREFIX?>-<?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_NO:$headerDet->SH_ORDER_NO?></td>
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
  <td width="18%">E-Invoice QR Code <img src="<?=$qr_image?>" alt="" class="rounded avatar-lg" style="width:7rem;height:7rem;"></td>
