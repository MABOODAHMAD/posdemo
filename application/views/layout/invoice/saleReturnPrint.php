                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                  <td width="8%"><?php if($poItemDet->I_PRINTABLE == 'Y'){ ?><img src="<?=base_url('uploads/images/item/').$poItemDet->I_IMAGE_FILENAME?>" alt="<?=$poItemDet->I_IMAGE_FILENAME?>" title="<?=$poItemDet->I_IMAGE_FILENAME?>" class="avatar-md"><?php }else{ ?><img src="<?=base_url('uploads/images/item/no_image.png')?>" alt="no_image" title="no_image" class="avatar-md"><?php } ?> <?=$poItemDet->I_CODE?></td>
                                                    ...
                                                    <td width="2%">&nbsp;</td>
                                                    <td width="2%"><?=$poItemDet->RD_QTY?></td>
                                                    <!--<td width="15%"><?=$poItemDet->RD_SALE_PRICE?></td>-->
                                                    <!--<td width="15%"><?=$poItemDet->RD_DIST_AMT?></td>-->
                                                    <td width="15%"><?=$poItemDet->RD_SUB_TOT?></td>
                                                    <td width="2%"><?=$poItemDet->I_FLAMMABLE == 'Y'?'15%':'Tax Free'?></td>
                                                    
                                                    <td width="15%"><?=$poItemDet->RD_VAT_AMT?></td>
                                                    <td width="15%"><?=(($poItemDet->RD_SUB_TOT-$poItemDet->RD_DIST_AMT)+($poItemDet->RD_VAT_AMT))?></td>
                                                </tr>
                                                <?php $sn++; endforeach; ?>
                                            </tbody>
                                        </table>
