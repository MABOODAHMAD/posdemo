...
<title>Mohammad Othman Al-Moallim  VAT Invoice English (<?=$headerDet->SH_INV_PREFIX?"Invoice":"Order"?> #<?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_PREFIX:$headerDet->SH_ORDER_PREFIX?>-<?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_NO:$headerDet->SH_ORDER_NO?>)</title>
</head>
...
<!-- ============================================================== -->
  ...
  <tr>
    <td width="20%"><img src="assets/images/logo-dark.png" width="176" height="40" /></td>
...
<br />                 
 <strong>PHONE</strong> :  <?=$wharehouse->WHSE_PHONE1?>. || <strong>FAX</strong>: <?=$wharehouse->WHSE_FAX1?></td>
    ...
    <td width="22%" align="right" valign="bottom" style="font-size:11px;">
	<strong style="
    font-size: initial;">
	INVOICE
	</strong>
    <br><strong>VAT No:</strong> 300232189200003<br />
     <h4 class="float-end font-size-16">
         <?=$headerDet->SH_INV_PREFIX?"Invoice":"Order"?> #<?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_PREFIX:$headerDet->SH_ORDER_PREFIX?>-<?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_NO:$headerDet->SH_ORDER_NO?></h4>
    ...
    <tr>
      <td height="5"  align="center" class="sdbod-t" style="text-align: left;">
          <!--<h1>VAT Invoice Original For Recipient</h1>-->          </td>
      </tr>
</table>
                                                ...
                                                <tr>
                                                    <td width="58%" style="padding: 0.0rem 0.2rem 0.2rem 0.5rem">
                                                        <div class="col-sm-12">
															...
															<div style="border: #e5dfdf solid 1px;border-radius: 8px; padding: 3px;">
															    <style>
															        .inv td{
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0" class="inv">
                                                              ...
                                                              <tr height="20">
                                                                <td height="20" dir="RTL" align="right" width="93">Name </td>
                                                                <td align="left" width="211"><?=$headerDet->CUST_NAME_AR.'-'.$headerDet->CUST_NAME?></td>
                                                                <td dir="RTL" align="right" width="165">Cust VAT No</td>
                                                                <td align="left" width="149"><?=$headerDet->CUST_TAX_EXEMPT_ID?></td>
                                                              </tr>
                                                              
                                                              <tr height="20">
                                                                <td height="20" dir="RTL" align="right">Street</td>
                                                                <td align="left"><?=$headerDet->CUST_STR_ADDR1?></td>
                                                                <td dir="RTL" align="right">Phone</td>
                                                                <td align="left"><?=$headerDet->CUST_PHONE1?></td>
                                                              </tr>
                                                              
                                                              <tr height="20">
                                                                <td height="20" dir="RTL" align="right">Address</td>
                                                                <td align="left"><?=$headerDet->CUST_POSTAL_CODE_ID?></td>
                                                                <td dir="RTL" align="right">Cell</td>
                                                                <td align="left"><?=$headerDet->CUST_PHONE2?></td>
                                                              </tr>
                                                              
                                                              <tr height="20">
                                                                <td height="20" dir="RTL" align="right">Postal Code</td>
                                                                <td align="left"><?=$headerDet->CUST_POSTAL_CODE_ID?>&nbsp;</td>
                                                                <td dir="RTL" align="right">Card No</td>
                                                                <td align="left"><!--Card No --><?=$headerDet->CUST_EDI1?></td>
                                                              </tr>
                                                              
                                                              <tr height="20">
                                                                <td height="20" dir="RTL" align="right">City </td>
                                                                <td align="left"><?=$headerDet->CTY_NAME?></td>
                                                                <td dir="RTL" align="right">Email </td>
                                                    ...
                                                    <td width="42%" align="right" style="padding: 0.0rem 0.5rem 0.2rem 0.2rem">
                                                        <div class="col-sm-12 text-sm-end">
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0" class="inv">
                                                              ...
                                                              <tr height="30">
                                                                <td height="30" dir="RTL" align="right" width="136">CR. No.</td>
                                                                <td align="left" width="295"><?=$wharehouse->WHSE_EDI1?> | Licence</td>
                                                              </tr>
                                                              ...
                                                              <tr height="31">
                                                                <td height="31" dir="RTL" align="right">Invoice No</td>
                                                                <td align="left" style="
    font-size: 15px;
    font-weight: 700;
"><?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_PREFIX:$headerDet->SH_ORDER_PREFIX?>-<?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_NO:$headerDet->SH_ORDER_NO?></td>
                                                              </tr>
                                                              
                                                              <tr height="20">
                                                                <td height="20" dir="RTL" align="right">Type</td>
                                                                <td align="left"><?=$headerDet->SH_TERM_ID == '997'?'CASH':'CREDIT'?></td>
                                                              </tr>
                                                              
                                                              <tr height="20">
                                                                <td height="20" dir="RTL" align="right">Invoice Date</td>
                                        ...
                                        <table class="table table-hover table-striped table-bordered " style="margin-bottom: 0.3rem;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                  <td width="8%"><?php if($poItemDet->I_PRINTABLE == 'Y'){ ?><img src="<?=base_url('uploads/images/item/').$poItemDet->I_IMAGE_FILENAME?>" alt="<?=$poItemDet->I_IMAGE_FILENAME?>" title="<?=$poItemDet->I_IMAGE_FILENAME?>" class="avatar-md"><?php }else{ ?><img src="<?=base_url('uploads/images/item/no_image.png')?>" alt="no_image" title="no_image" class="avatar-md"><?php } ?> <?=$poItemDet->SD_ITEM_CODE?></td>
                                                    <td width="15%">
                                                        <?=$poItemDet->I_DESC?>
                                                        <!--<br>-->
                                                        <!--<?=$poItemDet->I_EXTEND_DESC?>-->
                                                        <div style="font-size: smaller;"> <?=$weight->gold?'Go:'.$weight->gold:''?><?=$weight->diamond?',Di:'.$weight->diamond:''?> <?php if($poItemDet->I_CLEARITY){ ?>,&nbsp;&nbsp;|&nbsp;&nbsp; درجة نقاء الالماس : VS:<?=$poItemDet->I_CLEARITY?> ,<?php }if($poItemDet->I_CLR_COLOR){ ?> لون G:<?=$poItemDet->I_CLR_COLOR?> <?php }?></div>
                                                        </td>
                                                    <td width="2%"><?=$poItemDet->I_UOM_CODE?></td>
                                                    <td width="2%"><?=$poItemDet->SD_QTY?></td>
                                                    <td width="15%"><?=$poItemDet->SD_SALE_PRICE?></td>
                                                    <!--<td width="15%"><?=$poItemDet->SD_DIST_AMT?></td>-->
                                                    <td width="15%"><?=number_format($poItemDet->SO_SUB_TOT,2)?></td>
                                                    <td width="2%">15%</td>
                                                    
                                                    <td width="15%"><?=number_format($poItemDet->SO_VAT_AMT,2)?></td>
                                                    <td width="15%"><?=number_format((($poItemDet->SO_SUB_TOT-$poItemDet->SD_DIST_AMT)+($poItemDet->SO_VAT_AMT)),2)?></td>
                                                </tr>
                                                <?php $sn++; endforeach; ?>
  ...
  <tr>
    <td width="35%" rowspan="4"  align="center" valign="top"  class="sdbod-r sdbod-t sdbod-b sdbod-l">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="inv">
                                                    <tbody>
                                                        <tr>
                                                            <td style="width: 12%;"><strong>Payment Details:</strong></td>
                                                            <td style="width: 12%;"><strong>Amount</strong></td>
                                                        </tr>
    ...
    <td width="21%" class="sdbod-b sdbod-t"><b>Total Qty:</b></td>
    <td width="21%" align="right" class="sdbod-b sdbod-l sdbod-t sdbod-r"><span id="tot-qty"><?=$headerDet->SH_TOT_QTY?></span></td>
    </tr>
  <tr>
    <td class="sdbod-b"><b> Subtol(VAT Excluded):</b></td>
    <td align="right" class="sdbod-b sdbod-l sdbod-r"><?=sysCur()?> <?=number_format($headerDet->SH_SUB_TOT-$headerDet->SH_TOT_DISCOUNT,2)?></td>
    </tr>
  <tr>
    <td class="sdbod-b"><b>Total VAT:</b></td>
    <td align="right" class="sdbod-b sdbod-l sdbod-r"><?=sysCur()?> <?=number_format($headerDet->SH_TOT_VAT,2)?></td>
    </tr>
  <tr>
    <td bgcolor="#E4E4E4" class="sdbod-b"><b>Total (VAT Included): </b></td>
    <td bgcolor="#E4E4E4" align="right" class="sdbod-b sdbod-l sdbod-r" ><strong><span id="curt-cur-abbre-grnd-tot"><?=sysCur()?></span> <span id="grand-tot"><?=number_format($headerDet->SH_GRAND_TOT,2)?></span> </strong></td>
    </tr>
  </table>
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="4%">&nbsp;</td>
    <td width="24%"><div align="center">Prepared By<br>
      Abdullah Alamoudi</div></td>
    <td width="3%">&nbsp;</td>
    <td width="32%"><div align="center">Salesman <br>
      Basil aL Sadat</div></td>
    <td width="3%">&nbsp;</td>
    <td width="31%"><div align="center">Customer's Signature <br />
توقيع العميل استلمت القطع بالموصفات الموضحه بالفاتورة<br />
      وانا على علم بسياسه الاستبدال والاسترجاع</div></td>
    <td width="3%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
  <td width="18%">&nbsp;</td>
    <td width="80%" ><div align="right" style="font-size: larger;"> شروط استرجاع او تبديل البضاعه المباعه *<br />
 ...
 almoallimjewelrysa.com للتسوق عبر الموقع الالكترونى والتطبيق زورونا على &#8226;
  ...
  <tr>
    ...
    <td valign="top"><div align="right" style="font-size: larger;"><strong>تفضلو بزيارة معارضنا في آل من</strong>
	<br />
