...
<!-- ============================================================== -->
  ...
  <tr>
   ...
   <br>920016990 </h2>
   <?=$wharehouse->WHSE_DESC?> - <?=$wharehouse->WHSE_STR_ADDR1.'- '.$wharehouse->WHSE_STR_ADDR2?> 
<br />                 
 <strong>PHONE</strong> :  <?=$wharehouse->WHSE_PHONE1?>. || <strong>FAX</strong>: <?=$wharehouse->WHSE_FAX1?></td>
...
">فاتورة ضريبية مبسطة</strong>
    <br><strong>الرقم الضريبى:</strong> 300232189200003<br />
     ...
     <?=$wharehouse->WHSE_EDI1?> 
	  ...
	  <tr>
				<td width="30%" align="center" class=" sdbod-t sdbod-r sdbod-b sdbod-l"><span class="style17"><strong> <?=$headerDet->SH_TERM_ID == '997'?'CASH':'CREDIT'?></strong>  &#1606;&#1608;&#1593; &#1575;&#1604;&#1601;&#1575;&#1578;&#1608;&#1585;&#1577;</span> </td>
				<td width="30%" align="center" class=" sdbod-t sdbod-r sdbod-b "><span class="style17"><strong> <?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_PREFIX:$headerDet->SH_ORDER_PREFIX?>-<?=$headerDet->SH_INV_PREFIX?$headerDet->SH_INV_NO:$headerDet->SH_ORDER_NO?> </strong> &#1585;&#1602;&#1605; &#1575;&#1604;&#1601;&#1575;&#1578;&#1608;&#1585;&#1577;</span></td>
				<td width="30%" align="center" class=" sdbod-t sdbod-r sdbod-b"><span class="style17"><strong> <?=date('d-M Y', strtotime($headerDet->SH_ORDER_DATE))?> : </strong> &#1578;&#1575;&#1585;&#1610;&#1582; &#1575;&#1604;&#1601;&#1575;&#1578;&#1608;&#1585;&#1607;</span></td>
			    <td width="10%" align="center" class=" sdbod-t sdbod-r sdbod-b">Page 1-1 </td>
                                        ...
                                        <div class="row">
                                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="58%" style="padding: 0.0rem 0.2rem 0.2rem 0.5rem">
                                                        <div class="col-sm-12">
                                                            
<div style="border: #e5dfdf solid 1px;border-radius: 8px; padding: 3px; margin-right: 6px;">
															    <style>
															        .inv td{
													...
													<table width="100%" cellpadding="0" cellspacing="0" class="inv">
                                                              ...
                                                              <tr height="20">
                                                                ...
                                                                <td height="20" colspan="4" align="left"><?= $headerDet->CUST_CODE.'-'.$headerDet->CUST_NAME_AR.'-'.$headerDet->CUST_NAME?></td>
                                                                <td width="111" align="left">&nbsp;</td>
                                                                <td width="328" align="right" dir="rtl">&#1575;&#1604;&#1585;&#1602;&#1605; &#1575;&#1604;&#1590;&#1585;&#1610;&#1576;&#1610; &#1604;&#1604;&#1593;&#1605;&#1610;&#1604;</td>
                                                                <td width="37" align="left"><?=$headerDet->CUST_E_MAIL2?></td>
                                                              </tr>
                                                              
                                                              <tr height="20">
                                                                <td height="20" align="right" dir="rtl">&#1575;&#1604;&#1588;&#1575;&#1585;&#1593;</td>
                                                                <td width="52" align="left"><?=$headerDet->CUST_STR_ADDR1?></td>
                                                                <td width="144" height="20" align="right" dir="rtl">&#1575;&#1604;&#1605;&#1583;&#1610;&#1606;&#1577;</td>
                                                                <td width="162" align="left"><?=$headerDet->CTY_NAME?></td>
                                                                <td width="151" align="right" dir="rtl">&#1585;&#1602;&#1605; &#1575;&#1604;&#1576;&#1591;&#1575;&#1602;&#1577;</td>
                                                                <td align="left"><!--Card No -->
                                                                    <?=$headerDet->CUST_EDI1?></td>
                                                              ...
                                                              <tr height="20">
                                                                ...
                                                                <td align="left"><?=$headerDet->CUST_POSTAL_CODE_ID?>
  &nbsp;</td>
                                        ...
                                        <table class="table table-hover table-striped table-bordered " style="margin-bottom: 0.3rem;">
                                            <thead>
                                                <tr>
                                                  <th width="10%" align="center" style="text-align: center;">رقم القطعه</th>
                                                    <th width="40%" align="center" style="text-align: center;">وصف القطعة</th>
                                                    <th width="2%" align="center" style="text-align: center;">الوحدة</th>
                                                    <th width="2%" align="center" style="text-align: center;">الكمية</th>
                                                    <!--<th width="15%">السعر القطعة</th>-->
                                                    <!--<th width="15%">Total Discount</th>-->
                                                    <th width="10%" align="center" style="text-align: center;">السعر بعد الخصم</th>
                                                    <th width="2%" align="center" style="text-align: center;"> نسبة الضريبه</td>
                                                    <th width="10%"  align="center" style="text-align: center;">ضريبة القيمة المضافة بالريال </th>
                                                    <th width="20%" align="center" style="text-align: center;">المبلغ شامل الضريبة بالريال</th>
    ...
    <tr>
              <td width="5%" style="text-align: center;"><?php if($poItemDet->I_PRINTABLE == 'Y'){ ?><img src="<?=base_url('uploads/images/item/').$poItemDet->I_IMAGE_FILENAME?>" alt="" title="<?=$poItemDet->I_IMAGE_FILENAME?>" class="avatar-md"><?php }else{ ?><img src="<?=base_url('uploads/images/item/no_image.png')?>" alt="no_image" title="no_image" class="avatar-md"><?php } ?> <?=$poItemDet->SD_ITEM_CODE?></td>
                <td width="25%" style="text-align: center;">
                    <?//=$poItemDet->I_DESC?><!--<br>-->
                    <?=$poItemDet->I_EXTEND_DESC?>
                    <div style="font-size: 11px;"> <?=$weight->gold?'Go:'.$weight->gold:''?><?=$weight->diamond?',Di:'.$weight->diamond:''?> <?php if($poItemDet->I_CLEARITY){ ?>,&nbsp;&nbsp;|&nbsp;&nbsp; درجة نقاء الالماس : VS:<?=$poItemDet->I_CLEARITY?> ,<?php }if($poItemDet->I_CLR_COLOR){ ?> لون G:<?=$poItemDet->I_CLR_COLOR?> <?php }?></div>
              </td>
                <td width="2%" style="font-size: 11px; text-align: center;"><?=$poItemDet->I_UOM_CODE?></td>
                <td width="2%" style="text-align: center;"><?=$poItemDet->SD_QTY?></td>
                <!--<td width="15%"><?=$poItemDet->SD_SALE_PRICE?></td>-->
                <!--<td width="15%"><?=number_format($poItemDet->SD_DIST_AMT,2)?></td>-->
                <td width="15%" style="text-align: center;"><?=number_format($poItemDet->SO_SUB_TOT,2)?></td>
                <td width="2%" style="text-align: center;">15%</td>
                
                <td width="15%" style="text-align: center;"><?=number_format($poItemDet->SO_VAT_AMT,2)?></td>
                <td width="15%" style="text-align: center;"><?=number_format((($poItemDet->SO_SUB_TOT-$poItemDet->SD_DIST_AMT)+($poItemDet->SO_VAT_AMT)),2)?></td>
    </tr>
                                                <?php $sn++; endforeach; ?>
                                                
                                                <?php if($sn<5){
		$i1=$sn+1; for($j=$i1;$j<=5;$j++){ ?>
		...
		<tr>
            ...
            <td width="2%">&nbsp;</td>
            <!--<td width="15%"><?=$poItemDet->SD_SALE_PRICE?></td>-->
            <!--<td width="15%"><?=$poItemDet->SD_DIST_AMT?></td>-->
            <td width="15%">&nbsp;</td>
            <td width="2%">&nbsp;</td>
            <td width="15%">&nbsp;</td>
            <td width="15%">&nbsp;</td>
  ...
  <?php } } ?>
                                        ...
                                        <tr>
                                            <td width="35%" rowspan="4"  align="center" valign="middle"  class="sdbod-r sdbod-t sdbod-b sdbod-l">
                                                <?php  if($headerDet->SH_SALE_TYPE == 'CREDIT'){ ?>
                                                    <strong><p>Your account as of today is <?=$custBal?></p></strong>
                                                <?php }else{ ?>
                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="inv">
                                                    <tbody>
                                                        <tr>
                                                            <td style="width: 12%;"><strong>تفاصيل الدفع</strong></td>
                                                            <td style="width: 12%;"><strong>المبلغ</strong></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="3" style="width: 12%;text-align: right;padding-right: 132px;"><strong>
    ...
    <td width="15%" rowspan="4"  align="center" class="sdbod-r sdbod-t sdbod-b"> 

         <img src="<?=$qr_image?>" alt="" class="rounded avatar-lg" style="width:7rem;height:7rem;">      </td>
    <td width="21%" class="sdbod-b sdbod-t" style="font-size: medium;"><b>اجمالى الكميه</b></td>
    <td width="21%" align="right" class="sdbod-b sdbod-l sdbod-t sdbod-r"><span id="tot-qty"><?=$headerDet->SH_TOT_QTY?></span></td>
    </tr>
  <tr>
    <td class="sdbod-b" style="font-size: medium;"><b>الاجمالى بددون الضريبه</b></td>
    <td align="right" class="sdbod-b sdbod-l sdbod-r"><?=sysCur()?> <?=number_format($headerDet->SH_SUB_TOT-$headerDet->SH_TOT_DISCOUNT,2)?></td>
    </tr>
  <tr>
    <td class="sdbod-b" style="font-size: medium;"><b>اجمالى الضريبه</b></td>
    <td align="right" class="sdbod-b sdbod-l sdbod-r"><?=sysCur()?> <?=number_format($headerDet->SH_TOT_VAT,2)?></td>
    </tr>
  <tr>
    <td bgcolor="#E4E4E4" class="sdbod-b" style="font-size: medium;"><b>الاجمالى شامل الضريبه </b></td>
    <td bgcolor="#E4E4E4" align="right" class="sdbod-b sdbod-l sdbod-r" ><strong style="font-size: medium;"><span id="curt-cur-abbre-grnd-tot"><?=sysCur()?></span> <span id="grand-tot"><?=number_format($headerDet->SH_GRAND_TOT,2)?></span> </strong></td>
    </tr>
  </table>
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="24%" style="
    font-size: 12px;
"><div align="center">أصدرت من قبل <br>
      Abdullah Alamoudi</div></td>
    <td width="3%">&nbsp;</td>
    <td width="20%" style="
    font-size: 12px;
"><div align="center">البائع <br>
      Basil aL Sadat</div></td>
    <td width="3%">&nbsp;</td>
    <td width="26%" style="
    font-size: 13px;
"><div align="center">
...
<br>
وانا علی علم بسیا سه الا ستبدال و الا سترجاع
      </div></td>
    <td width="5%">&nbsp;</td>
  </tr>
  <tr>
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
  <td width="18%">&nbsp;</td>
    <td width="80%" ><div align="right" style="font-size: 13px;"> شروط استرجاع او تبديل البضاعه المباعه *<br />
 ...
 almoallimjewelrysa.com للتسوق عبر الموقع الالكترونى والتطبيق زورونا على &#8226;
  ...
  <tr>
    ...
    <td valign="top"><div align="right" style="font-size: 13px;"><strong> : تفضلو بزيارة معارضنا في كل من 
    </strong>
	<br />
