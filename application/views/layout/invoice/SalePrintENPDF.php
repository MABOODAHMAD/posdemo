...
<!--#################### HEAD START  ##############################-->
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  style="margin-bottom: 0.3rem;">
                                            <thead>
                                                ...
                                                <tr>
                                                  <th width="10%" align="center" bgcolor="#E4E4E4" style="text-align: center;">Item No</th>
                                                    <th width="40%" align="center" bgcolor="#E4E4E4" style="text-align: center;">Description</th>
                                                    <th width="2%" align="center" bgcolor="#E4E4E4" style="text-align: center;">UOM</th>
                                                    <th width="2%" align="center" bgcolor="#E4E4E4" style="text-align: center;">Qty</th>
                                                    <!--<th width="15%">السعر القطعة</th>-->
                                                    <!--<th width="15%">Total Discount</th>-->
                                                    <th width="10%" align="center" bgcolor="#E4E4E4" style="text-align: center;">Price Aft Disc </th>
                                                    <th width="2%" align="center" bgcolor="#E4E4E4" style="text-align: center;"> VAT% </td>
                                                    <th width="10%"  align="center" bgcolor="#E4E4E4" style="text-align: center;">VAT Amount</th>
                                                    <th width="20%" align="center" bgcolor="#E4E4E4" style="text-align: center;">Total Amount</th>
    ...
    <tr>
              <td width="5%" style="text-align: center; border-bottom:#000000 solid 1px;"><?php if($poItemDet->I_PRINTABLE == 'Y'){ ?><img src="<?=base_url('uploads/images/item/').$poItemDet->I_IMAGE_FILENAME?>" alt="" title="<?=$poItemDet->I_IMAGE_FILENAME?>" class="avatar-md"><?php }else{ ?><img src="<?=base_url('uploads/images/item/no_image.png')?>" alt="no_image" title="no_image" class="avatar-md"><?php } ?> <?=$poItemDet->SD_ITEM_CODE?></td>
                ...
                <td width="15%" style="text-align: center; border-bottom:#000000 solid 1px;"><?=number_format($poItemDet->SO_SUB_TOT,2)?></td>
                <td width="2%" style="text-align: center; border-bottom:#000000 solid 1px;">15%</td>
                
                <td width="15%" style="text-align: center; border-bottom:#000000 solid 1px;"><?=number_format($poItemDet->SO_VAT_AMT,2)?></td>
                <td width="15%" style="text-align: center; border-bottom:#000000 solid 1px;"><?=number_format((($poItemDet->SO_SUB_TOT-$poItemDet->SD_DIST_AMT)+($poItemDet->SO_VAT_AMT)),2)?></td>
    </tr>
                                                <?php $sn++; endforeach; ?>
...
<div style="width:38%; height:131px;  border:#000000 solid 1px; padding:5px; float:left; text-align:center; vertical-align:middle;">
    ...
    <?php  if($headerDet->SH_SALE_TYPE == 'CREDIT'){ ?>
                                        ...
                                        <table width="30%" hight="300px" border="0" cellpadding="0" cellspacing="0" style="font-size: 16px;">
                                                <tbody>
                                                    <tr>
                                                        <td width="217"><strong>Payment Details:</strong></td>
...
<div style="width:41%;  border:#000000 solid 0px; padding:0px; float:left;">  
     ...
     <tr>
        <td width="21%" height="35" class="sdbod-b sdbod-t" style="font-size:12px;"><strong>Total Qty:</strong></td>
        <td width="21%"  align="right" class="sdbod-b sdbod-l sdbod-t sdbod-r"><span id="tot-qty"><?=$headerDet->SH_TOT_QTY?></span></td>
        </tr>
      <tr>
        <td height="35" class="sdbod-b" style="font-size:12px;"><strong>Subtol(VAT Excluded):</strong></td>
        <td align="right" class="sdbod-b sdbod-l sdbod-r"><?=sysCur()?> <?=number_format($headerDet->SH_SUB_TOT-$headerDet->SH_TOT_DISCOUNT,2)?></td>
        </tr>
      <tr>
        <td height="35" class="sdbod-b" style="font-size:12px;"><strong>Total VAT:</strong></td>
        <td align="right" class="sdbod-b sdbod-l sdbod-r"><?=sysCur()?> <?=number_format($headerDet->SH_TOT_VAT,2)?></td>
        </tr>
      <tr>
        <td height="37" bgcolor="#E4E4E4" class="sdbod-b" style="font-size:12px;"><strong>Total (VAT Included):</strong></td>
        <td bgcolor="#E4E4E4" align="right" class="sdbod-b sdbod-l sdbod-r" ><strong style="font-size:12px;"><span id="curt-cur-abbre-grnd-tot"><?=sysCur()?></span> <span id="grand-tot"><?=number_format($headerDet->SH_GRAND_TOT,2)?></span> </strong></td>
      </tr>
      </table>   
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top: 1.5rem;">
  <tr>
    <td width="27%" align="center" style="font-size: 12px;">Prepared By<br>
      Abdullah Alamoudi</td>
    <td width="5%">&nbsp;</td>
    
    
    <td width="26%" align="center" style="font-size: 12px;">Salesman<br>
      Basil aL Sadat</td>
