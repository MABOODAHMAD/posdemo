                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                <label for="validationCustom03" class="form-label">Currency Code</label>
                                                                    <input type="text" class="form-control" name="CUR_ID" placeholder="Auto generate if empty">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                <label for="validationCustom03" class="form-label">Currency Name</label>
                                                                    <input type="text" class="form-control" name="CUR_NAME" placeholder="Enter Currency Name ">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                <label for="validationCustom03" class="form-label">Currency Arbic Name</label>
                                                                    <input type="text" class="form-control" name="CUR_NAME_AR" placeholder="Enter Currency Name ">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="CUR_ABBRV" placeholder="Enter Abbreviation">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                               ...
                                                               <input type="text" class="form-control" name="CUR_NOTES" placeholder="Enter Notes">
