/<!--
 *  WAREHOUSE DATA WHEN A LOGIN SPECIFIC USER 
 *  
 *  
 *  
 *  
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="mt-4 mt-xl-3">
                                                    ...
                                                    <h5 class="mb-4">Price :  <b>KSA Prise <?=$itemDets[0]['I_LIST_PRICE']?$itemDets[0]['I_LIST_PRICE']:'Undefined'?> SR</b></h5>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <?php }else if($sesData->USER_TYPE == 'USER'){ 
                                            ...
                                            foreach ($whse_assign as $whse_assignGet):
                                                if($whse_assignGet->SMSW_WHSE_CODE == '01'){
                                                    $defWhseCheck = TRUE;
                                                    break;
                                                }
                                            endforeach;
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped table-condensed dfTable two-columns">
                                                ...
                                                <?php foreach($whseDets as $whseDet):
                                                        ...
                                                        foreach ($whse_assign as $whse_assignGet):
                                                            if($whse_assignGet->SMSW_WHSE_CODE != '01'){
                                                                if($whse_assignGet->SMSW_WHSE_CODE == $whseDet->WHSE_CODE){
                                                                    $item_P = array(
                                                                        "dataType" => 'row',
                                                                        "itemCode" => $itemDets[0]['I_CODE'],
                                                                        "whseId" => $whseDet->WHSE_CODE,
                                                ...
                                                <?php $checkWhseQty = true; }else{ $checkWhseQty = true;?>
                                                    <td><?= $whseDet->WHSE_CODE . '-' . $whseDet->WHSE_DESC ?></td>
                                                    <td><strong><?=$stockDet?$stockDet:0?></strong></td>
                                                <?php } } } endforeach; endforeach; if(!$checkWhseQty){ ?>
