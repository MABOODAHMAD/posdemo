                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">ITEMS BULK UPLOAD</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                            ...
                                            <div class="card-body">
                                                <div class="card-body border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <h5 class="mb-0 card-title flex-grow-1">Item bulk upload</h5>
                                                ...
                                                <div class="card-border mb-3 card card-body border-success"> 
                                                    ...
                                                    <a href="<?=base_url('uploads/item/template/ITEM UPLOAD SHEET.xlsx')?>" download="">
                                        ...
                                        <div class="card-body">
                                            <form id="formdata">
                                                <div class="row">
                                                    ...
                                                    <div>
                                                        <button data-aftreload="true" data-control="upload/item-bulk-upload" data-form="formdata" data-sweetalert="<?=$sweetAlertMsg->prodAdd->msg?>" data-sweetalertcontrol="<?=$sweetAlertMsg->prodAdd->cont?>" class="ajaxform btn btn-success waves-effect waves-light">Add Items</button>
                                                    </div>
                                                    <span id="outmsg"></span>
                                                </div>
                                            </form>
